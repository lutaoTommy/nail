...
func initLanguageZhcn() {
	...
	/*mail*/
	languageMapZhcn["MAIL_VERIFY_SUBJECT"] = "TintaShift 验证码"
	languageMapZhcn["MAIL_VERIFY_TITLE"] = "欢迎使用 TintaShift"
	languageMapZhcn["MAIL_VERIFY_DESC"] = "您好，您正在进行账户安全验证，您的验证码是："
	languageMapZhcn["MAIL_VERIFY_SECURITY_TITLE"] = "安全提示："
	languageMapZhcn["MAIL_VERIFY_SECURITY_DESC"] = "TintaShift 的工作人员绝不会向您索要此验证码，请勿告知任何人。"
	languageMapZhcn["MAIL_VERIFY_IGNORE"] = "如果您未曾请求此验证码，请忽略此邮件。"
	languageMapZhcn["MAIL_COPYRIGHT"] = "© 2026 TintaShift. 保留所有权利。"
